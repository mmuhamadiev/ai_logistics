...
class FullScreenOrderSelectionDialog extends StatefulWidget {

  const FullScreenOrderSelectionDialog({Key? key, required this.isMobile}) : super(key: key);
  
  final bool isMobile;

  @override
  _FullScreenOrderSelectionDialogState createState() =>
      _FullScreenOrderSelectionDialogState();
}

class _FullScreenOrderSelectionDialogState extends State<FullScreenOrderSelectionDialog> with SingleTickerProviderStateMixin{
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return OrderCard(order: order, isSelected: isSelected, onTap: () {
                                        setState(() {
                          ...
                          Expanded(
                            child: selectedOrders.isEmpty
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return SelectedOrderCard(index: index, order: order, key: Key('$index'), onRemove: () {
                                  setState(() {
                                    selectedOrders.remove(order);
                          ...
                          selectedOrders.isNotEmpty
                            ...
                            onConfirm: () async{
                              ...
                              if(result) {
                                ...
                                var isTeamLead = user.user.userRole == UserRoles.allRoles[1];
                                if (isTeamLead == false) {
                                  showTopSnackbarInfo(
                                      context, 'You do not have access');
                                  return;
                                } else {
                                  _confirmOrder(context, selectedOrders);
                                }
                              } else {
...
class OrderCard extends StatelessWidget {
  ...
  OrderCard({required this.order, required this.isSelected, required this.onTap});
...
class SelectedOrderCard extends StatelessWidget {
  ...
  SelectedOrderCard({required this.index, required this.order, required this.key, required this.onRemove});
