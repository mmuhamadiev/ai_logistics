...
class EditOrderDialog extends StatefulWidget {
  ...
  const EditOrderDialog({Key? key, required this.order}) : super(key: key);
...
class _EditOrderDialogState extends State<EditOrderDialog>
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<OrderStatus>(
                  ...
                  items: [OrderStatus.Pending, OrderStatus.Canceled, OrderStatus.ClientCanceled, OrderStatus.Problematic].map((status) {
  ...
  void _saveOrder() async{
    ...
    if(result) {
      ...
      var isOrderLastStartEditTimeChanged = await context.read<OrderListCubit>().isOrderLastStartEditTimeChanged(widget.order.orderID, widget.order.lastModifiedAt);
      ...
      if(isOrderLastStartEditTimeChanged) {
        ...
        context.read<OrderListCubit>().editOrder(updatedOrder, user.user.userID, user.user.username);
        return;
      }
    } else {
