...
class UserDashboardOverview extends StatefulWidget {
  const UserDashboardOverview({Key? key}) : super(key: key);

  @override
  State<UserDashboardOverview> createState() => _UserDashboardOverviewState();
}

class _UserDashboardOverviewState extends State<UserDashboardOverview> {
          ...
          Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Flexible(
                    child: SelectableText(group.groupID,
                        style: AppTextStyles.body16RobotoMedium
